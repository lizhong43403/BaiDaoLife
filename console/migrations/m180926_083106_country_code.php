...
class m180926_083106_country_code extends Migration {
    ...
    public function safeUp() {
        ...
        // 圣卢西亚，又称圣露西亚
        // fixme: 国家代码项需要手动录入到数据库，并更新此处数据
        $this->batchInsert('{{%country_code}}', ['english_name', 'chinese_name', 'chinese_name_short', 'domain_abbreviation', 'area_code', 'time_difference', 'created_at'], [
            ['Angola', '安哥拉共和国', '安哥拉', 'AO', '244', '-7', time()],
            ['Afghanistan', '阿富汗伊斯兰共和国', '阿富汗', 'AF', '93', '0', time()],
            ['Albania', '阿尔巴尼亚共和国', '阿尔巴尼亚', 'AL', '355', '-7', time()],
            ['Algeria', '阿尔及利亚民主人民共和国', '阿尔及利亚', 'DZ', '213', '-8', time()],
            ['Andorra', '安道尔公国', '安道尔共和国', 'AD', '376', '-8', time()],
            ['Anguilla', '安圭拉岛', '安圭拉岛', 'AI', '1264', '-12', time()],
            ['Antigua and Barbuda', '安提瓜和巴布达', '安提瓜和巴布达', 'AG', '1268', '-12', time()],
            ['Argentina', '阿根廷共和国', '阿根廷', 'AR', '54', '-11', time()],
            ['Armenia', '亚美尼亚共和国', '亚美尼亚', 'AM', '374', '-6', time()],
            ['Ascension Island', '阿森松岛', '阿森松岛', 'AC', '247', '-8', time()],
            ['Australia', '澳大利亚联邦', '澳大利亚', 'AU', '61', '+2', time()],
            ['Austria', '奥地利共和国', '奥地利', 'AT', '43', '-7', time()],
            ['Azerbaijan', '阿塞拜疆共和国', '阿塞拜疆', 'AZ', '994', '-5', time()],
            ['Bahamas', '巴哈马国', '巴哈马', 'BS', '1242', '-13', time()],
            ['Bahrain', '巴林王国', '巴林', 'BH', '973', '-5', time()],
            ['Bangladesh', '孟加拉人民共和国', '孟加拉国', 'BD', '880', '-2', time()],
            ['Barbados', '巴巴多斯岛', '巴巴多斯', 'BB', '1246', '-12', time()],
            ['Belarus', '白俄罗斯', '白俄罗斯', 'BY', '375', '-6', time()],
            ['Belgium', '比利时王国', '比利时', 'BE', '32', '-7', time()],
            ['Belize', '伯利兹', '伯利兹', 'BZ', '501', '-14', time()],
            ['Benin', '贝宁共和国', '贝宁', 'BJ', '229', '-7', time()],
            ['Bermuda Is.', '百慕大群岛', '百慕大群岛', 'BM', '1441', '-12', time()],
            ['Bolivia', '多民族玻利维亚国', '玻利维亚', 'BO', '591', '-12', time()],
            ['Botswana', '博茨瓦纳', '博茨瓦纳', 'BW', '267', '-6', time()],
            ['Brazil', '巴西联邦共和国', '巴西', 'BR', '55', '-11', time()],
            ['Brunei', '文莱达鲁萨兰国', '文莱', 'BN', '673', '0', time()],
            ['Bulgaria', '保加利亚共和国', '保加利亚', 'BG', '359', '-6', time()],
            ['Burkina-faso', '布基纳法索', '布基纳法索', 'BF', '226', '-8', time()],
            ['Burma', '缅甸联邦共和国', '缅甸', 'MM', '95', '-1.3', time()],
            ['Burundi', '布隆迪共和国', '布隆迪', 'BI', '257', '-6', time()],
            ['Cameroon', '喀麦隆共和国', '喀麦隆', 'CM', '237', '-7', time()],
            ['Canada', '加拿大', '加拿大', 'CA', '1', '-13', time()],
            ['Cayman Is.', '开曼群岛', '开曼群岛', '', '1345', '-13', time()],
            ['Central African Republic', '中非共和国', '中非共和国', 'CF', '236', '-7', time()],
            ['Chad', '乍得共和国', '乍得', 'TD', '235', '-7', time()],
            ['Chile', '智利共和国', '智利', 'CL', '56', '-13', time()],
            ['China', '中华人民共和国', '中国', 'CN', '86', '0', time()],
            ['Colombia', '哥伦比亚共和国', '哥伦比亚', 'CO', '57', '0', time()],
            ['Congo', '刚果共和国', '刚果', 'CG', '242', '-7', time()],
            ['Cook Is.', '库克群岛', '库克群岛', 'CK', '682', '-18.3', time()],
            ['Costa Rica', '哥斯达黎加', '哥斯达黎加', 'CR', '506', '-14', time()],
            ['The Republic of Cuba', '古巴共和国', '古巴', 'CU', '53', '-13', time()],
            ['Cyprus', '塞浦路斯共和国', '塞浦路斯', 'CY', '357', '-6', time()],
            ['Czech Republic', '捷克共和国', '捷克', 'CZ', '420', '-7', time()],
            ['Denmark', '丹麦王国', '丹麦', 'DK', '45', '-7', time()],
            ['Djibouti', '吉布提共和国', '吉布提', 'DJ', '253', '-5', time()],
            ['Dominica Rep.', '多米尼加共和国', '多米尼加共和国', 'DO', '1890', '-13', time()],
            ['Ecuador', '厄瓜多尔共和国', '厄瓜多尔', 'EC', '593', '-13', time()],
            ['Egypt', '阿拉伯埃及共和国', '埃及', 'EG', '20', '-6', time()],
            ['EI Salvador', '萨尔瓦多共和国', '萨尔瓦多', 'SV', '503', '-14', time()],
            ['Estonia', '爱沙尼亚共和国', '爱沙尼亚', 'EE', '372', '-5', time()],
            ['Ethiopia', '埃塞俄比亚联邦民主共和国', '埃塞俄比亚', 'ET', '251', '-5', time()],
            ['Fiji', '斐济群岛共和国', '斐济', 'FJ', '679', '+4', time()],
            ['Finland', '芬兰共和国', '芬兰', 'FI', '358', '-6', time()],
            ['France', '法兰西共和国', '法国', 'FR', '33', '-8', time()],
            ['French Guiana', '法属圭亚那', '法属圭亚那', 'GF', '594', '-12', time()],
            ['Gabon', '加蓬共和国', '加蓬', 'GA', '241', '-7', time()],
            ['Gambia', '冈比亚共和国', '冈比亚', 'GM', '220', '-8', time()],
            ['Georgia', '格鲁吉亚', '格鲁吉亚', 'GE', '995', '0', time()],
            ['Germany', '德意志联邦共和国', '德国', 'DE', '49', '-7', time()],
            ['Ghana', '加纳共和国', '加纳', 'GH', '233', '-8', time()],
            ['Gibraltar', '直布罗陀', '直布罗陀', 'GI', '350', '-8', time()],
            ['Greece', '希腊共和国', '希腊', 'GR', '30', '-6', time()],
            ['Grenada', '格林纳达', '格林纳达', 'GD', '1809', '-14', time()],
            ['Guam', '关岛', '关岛', 'GU', '1671', '+2', time()],
            ['Guatemala', '危地马拉共和国', '危地马拉', 'GT', '502', '-14', time()],
            ['Guinea', '巴布亚新几内亚独立国', '几内亚', 'GN', '224', '-8', time()],
            ['Guyana', '圭亚那合作共和国', '圭亚那', 'GY', '592', '-11', time()],
            ['Haiti', '海地共和国', '海地', 'HT', '509', '-13', time()],
            ['Honduras', '洪都拉斯共和国', '洪都拉斯', 'HN', '504', '-14', time()],
            ['Hongkong', '香港', '香港', 'HK', '852', '0', time()],
            ['Hungary', '匈牙利共和国', '匈牙利', 'HU', '36', '-7', time()],
            ['Iceland', '冰岛共和国', '冰岛', 'IS', '354', '-9', time()],
            ['India', '印度共和国', '印度', 'IN', '91', '-2.3', time()],
            ['Indonesia', '印度尼西亚共和国', '印度尼西亚', 'ID', '62', '-0.3', time()],
            ['Iran', '伊朗伊斯兰共和国', '伊朗', 'IR', '98', '-4.3', time()],
            ['Iraq', '伊拉克共和国', '伊拉克', 'IQ', '964', '-5', time()],
            ['Ireland', '大不列颠及北爱尔兰联合王国', '爱尔兰', 'IE', '353', '-4.3', time()],
            ['Israel', '以色列国', '以色列', 'IL', '972', '-6', time()],
            ['Italy', '意大利共和国', '意大利', 'IT', '39', '-7', time()],
            ['Ivory Coast', '科特迪瓦', '科特迪瓦', 'KT', '225', '-6', time()],
            ['Jamaica', '牙买加', '牙买加', 'JM', '1876', '-12', time()],
